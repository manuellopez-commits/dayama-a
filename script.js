...
function showDedicationText() { //seguidores
  ...
  if (!text) {
    text = `Para Dayana🍓 :\n\nDesde el primer día sentí algo muy bonito contigo. Tal vez solo salimos una vez, pero la conexión fue real. Tienes unos ojos preciosos que dicen mucho más de lo que imaginas, y una forma de ser que se queda conmigo incluso cuando no estamos juntos
    . Me gusta hablar contigo todos los días, conocerte poco a poco. No sé qué nos depare el camino, pero si en algún punto podemos estar juntos ✨, sinceramente creo que sería de las cosas más bonitas que me podrían pasar.
Te quiero mucho ❤️,`;  } else {
...
function showSignature() {
  ...
  signature.textContent = firma ? decodeURIComponent(firma) : "Con amor, El Ing";
...
function showCountdown() {
  ...
  let eventDate = eventParam ? new Date(eventParam + 'T00:00:00') : new Date('2026-01-01T00:00:00');
  ...
  function update() {
    ...
    container.innerHTML =
      `Dia que han pasado: <b>${days}</b> días<br>` +
      `❤️ :: <b>${eventDays}d ${eventHours}h ${eventMinutes}m ${eventSeconds}s</b>`;
